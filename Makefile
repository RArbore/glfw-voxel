...
$(OUTPUT): objects/open-simplex-noise.o objects/texture.o objects/world.o objects/main.o
	gcc $(WFLAGS) -o $(OUTPUT) objects/open-simplex-noise.o objects/texture.o objects/world.o objects/main.o $(LFLAGS)
